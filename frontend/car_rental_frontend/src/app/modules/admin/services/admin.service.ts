...
export class AdminService {
  ...
  getCarById(id: number): Observable<any>{
    return this.http.get(BASE_URL+ "/api/admin/car/" + id, { headers: this.createAuthorizationHeader() })
  }

  updateCar(carId: number, carDto: any): Observable<any>{
    return this.http.put(BASE_URL+ "/api/admin/car/" + carId, carDto, { headers: this.createAuthorizationHeader() } )
  }
